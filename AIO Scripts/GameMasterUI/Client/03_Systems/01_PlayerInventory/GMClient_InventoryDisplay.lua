...
function PlayerInventory.createInventoryModal(playerName, inventoryData, equipmentData, bankData)
    ...
    -- Click outside dialog to close (only on background) - DISABLED for better usability
    ...
    dialog:SetScript("OnKeyDown", function(self, key)
        ...
        -- Handle keys not managed by HotkeyManager
        if key == "B" and IsAltKeyDown() and not IsControlKeyDown() then
